        ...
        <div class="flex justify-between h-14">
            <div class="flex sm:w-3/5">
                ...
                <div class="hidden sm:ml-6 sm:flex sm:space-x-8">
                    ...
                    <a href="{{ route('guide') }}" class="{{ \Request::route()->getName() == 'guide' ? 'border-blue-900 text-blue-900 font-semibold' : 'border-transparent text-gray-500 hover:border-gray-300 hover:text-blue-900' }} inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium hover:border-blue-900">
                        How it works
                    </a>
